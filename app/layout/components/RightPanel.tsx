...
interface RightPanelProps {
	rightPanelContainerRef: React.MutableRefObject<HTMLDivElement | undefined>;
}
					...
					<div className="col p-2">
						<div className="d-flex m-2 py-2">
							...
							<Paper elevation={0} className="col-10 ps-2 py-2 ">
								...
								<Chip label="Master Admin" color="primary" size="small" variant="outlined" />
							</Paper>
						</div>
					</div>
					<Button
						...
						endIcon={<LogoutOutlined rev={null} />}
						className="d-flex"
						variant="outlined"
						onClick={() => signOut()}
					>
